...
nui.MessageBox.buttonText = {
		ok: message.cap4jui.ok,
        cancel: message.cap4jui.cancel,
        yes: message.cap4jui.yes,
        no: message.cap4jui.no
};

nui.MessageBox.alertTitle = message.cap4jui.alertTitle;
nui.MessageBox.confirmTitle = message.cap4jui.confirmTitle;
nui.MessageBox.prompTitle = message.cap4jui.prompTitle;
nui.MessageBox.prompMessage = message.cap4jui.prompMessage;
...
nui.confirm = function (message, title, callback) {
	if(top.okBtnPosition=="left"){
	    ...
	    return nui.MessageBox.show({
	        ...
	        title: title || mini.MessageBox.confirmTitle,
	        buttons: ["cancel", "ok"],
			buttonsIconCls: ["icon-cancel","icon-ok"],
	        message: message,
	        iconCls: "mini-messagebox-question",
	        callback: callback
	    });

...
<html>
  ...
  <body>
    ...
    <div class="nui-fit">
      ...
      <form id="dataform1" method="post">
        <div style="padding-bottom: 5px; padding-top: 5px;">
          <input class="nui-hidden"  name="objectId" />
          <table style="table-layout: fixed;" align="center">
            <tr>
              ...
              <td colspan="1">
                <input class="nui-textbox" name="objectCode" required="false" visible="true">
              </input>
            </td>
            <td class="form_label">
              objectName:
            ...
            <td colspan="1">
              <input class="nui-textbox" name="objectName" required="false" visible="true">
            </input>
          </td>
        </tr>
        <tr>
          ...
          <td colspan="1">
            <input class="nui-textbox" name="objectDesc" required="false" visible="true">
          </input>
        </td>
        <td class="form_label">
          classId:
        ...
        <td colspan="1">
          <input class="nui-textbox" name="classId" required="false" visible="true">
        </input>
      </td>
    </tr>
    <tr>
    ...
    <td colspan="1">
      <input class="nui-textbox" name="sortno" required="false" visible="true">
    </input>
  </td>
</tr>
<tr>
...
<script type="text/javascript">
  ...
  function saveJson() {
    //保存
    var urlStr = "/store/portal/ptObject/save.do";
    var pageType = $J.getbyName("pageType").getValue();//获取当前页面是编辑还是新增状态
    //表示为编辑状态
    if (pageType == "edit") {
      urlStr = "/store/portal/ptObject/update.do";
    }
  ...
  function setData(data) {
    ...
    if (infos.pageType == "edit") {
      ...
      $J.postByAjax({"id":infos.objectId}, "/store/portal/ptObject/getPtObjectVOById.do", ajaxConf);
    }
  }
